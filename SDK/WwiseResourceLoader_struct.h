...
struct FWwiseAuxBusCookedData {
	...
	struct FName DebugName; // 0x28(0x08)
};
...
struct FWwiseEventCookedData {
	...
	struct FName DebugName; // 0x9c(0x08)
...
struct FWwiseGroupValueCookedData {
	...
	struct FName DebugName; // 0x0c(0x08)
};
...
struct FWwiseObjectInfo {
	...
	struct FName WwiseName; // 0x14(0x08)
	uint32_t HardCodedSoundBankShortId; // 0x1c(0x04)
};

// ScriptStruct WwiseResourceLoader.WwiseEventInfo
// Size: 0x24 (Inherited: 0x20)
struct FWwiseEventInfo : FWwiseObjectInfo {
	enum class EWwiseEventSwitchContainerLoading SwitchContainerLoading; // 0x20(0x01)
	enum class EWwiseEventDestroyOptions DestroyOptions; // 0x21(0x01)
...
struct FWwiseGroupValueInfo : FWwiseObjectInfo {
	uint32_t GroupShortId; // 0x20(0x04)
};
...
struct FWwiseInitBankCookedData : FWwiseSoundBankCookedData {
	...
	struct TArray<struct FWwiseMediaCookedData> Media; // 0x20(0x10)
	struct TArray<struct FWwiseLanguageCookedData> Language; // 0x30(0x10)
};
...
struct FWwiseLocalizedAuxBusCookedData {
	...
	struct FName DebugName; // 0x50(0x08)
	int32_t AuxBusId; // 0x58(0x04)
...
struct FWwisePlatformId {
	...
	struct FName PlatformName; // 0x10(0x08)
};
