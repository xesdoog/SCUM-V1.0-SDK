...
// Enum Engine.EMeshMergePackableTextures
enum class EMeshMergePackableTextures : uint8 {
	None = 0,
	Metallic = 1,
	Specular = 2,
	Roughness = 3,
	...
	OpacityMask = 6,
	AmbientOcclusion = 7,
	EMeshMergePackableTextures_MAX = 8
};
...
struct FPointDamageEvent : FDamageEvent {
	...
	struct FHitResult HitInfo; // 0x20(0x98)
};
...
struct FFindFloorResult {
	...
	struct FHitResult HitResult; // 0x0c(0x98)
};
...
struct FPredictProjectilePathResult {
	...
	struct FHitResult HitResult; // 0x2c(0x98)
...
struct FMeshMergingSettings {
	...
	char bPreserveOriginalUVChannel1 : 1; // 0x9e(0x01)
	char pad_9E_4 : 4; // 0x9e(0x01)
	char pad_9F[0x1]; // 0x9f(0x01)
	struct TArray<enum class EMeshMergePackableTextures> AdditionalPackedTextureChannels; // 0xa0(0x10)
	enum class TextureCompressionSettings AdditionalPackedTextureCompression; // 0xb0(0x01)
	bool AdditionalPackedTextureSRGB; // 0xb1(0x01)
	char bUseLandscapeCulling : 1; // 0xb2(0x01)
	char bIncludeImposters : 1; // 0xb2(0x01)
	char bAllowDistanceField : 1; // 0xb2(0x01)
	char pad_B2_3 : 5; // 0xb2(0x01)
...
struct FNavAgentProperties : FMovementProperties {
	...
	float AgentMaxSlope; // 0x10(0x04)
	float NavWalkingSearchHeightScale; // 0x14(0x04)
...
struct FBroadphaseSettings {
	enum class EBroadphaseType ClientBroadphaseAlgorithm; // 0x00(0x01)
	enum class EBroadphaseType ServerBroadphaseAlgorithm; // 0x01(0x01)
	char pad_2[0x2]; // 0x02(0x02)
	struct FBox MBPBounds; // 0x04(0x1c)
	uint32_t MBPNumSubdivs; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
	struct TArray<uint32_t> MBPRegionMask; // 0x28(0x10)
};
...
struct FHierarchicalSimplification {
	...
	struct FMeshMergingSettings MergeSetting; // 0xb8(0xb8)
	float DesiredBoundRadius; // 0x170(0x04)
	float DesiredFillingPercentage; // 0x174(0x04)
	int32_t MinNumberOfActorsToBuild; // 0x178(0x04)
