...
{
    class AChaosSolverActor* ChaosSolverActor;                                        // 0x0488 (size: 0x8)
    ...
    EObjectStateTypeEnum ObjectType;                                                  // 0x0590 (size: 0x1)
    bool EnableClustering;                                                            // 0x0591 (size: 0x1)
    int32 ClusterGroupIndex;                                                          // 0x0594 (size: 0x4)
    int32 MaxClusterLevel;                                                            // 0x0598 (size: 0x4)
    TArray<float> DamageThreshold;                                                    // 0x05A0 (size: 0x10)
    EClusterConnectionTypeEnum ClusterConnectionType;                                 // 0x05B0 (size: 0x1)
    int32 CollisionGroup;                                                             // 0x05B4 (size: 0x4)
    float CollisionSampleFraction;                                                    // 0x05B8 (size: 0x4)
    float LinearEtherDrag;                                                            // 0x05BC (size: 0x4)
    float AngularEtherDrag;                                                           // 0x05C0 (size: 0x4)
    class UChaosPhysicalMaterial* PhysicalMaterial;                                   // 0x05C8 (size: 0x8)
    EInitialVelocityTypeEnum InitialVelocityType;                                     // 0x05D0 (size: 0x1)
    FVector InitialLinearVelocity;                                                    // 0x05D4 (size: 0xC)
    FVector InitialAngularVelocity;                                                   // 0x05E0 (size: 0xC)
    class UPhysicalMaterial* PhysicalMaterialOverride;                                // 0x05F0 (size: 0x8)
    FGeomComponentCacheParameters CacheParameters;                                    // 0x05F8 (size: 0x50)
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsStateChange NotifyGeometryCollectionPhysicsStateChange; // 0x0648 (size: 0x10)
    void NotifyGeometryCollectionPhysicsStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsLoadingStateChange NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x0658 (size: 0x10)
    void NotifyGeometryCollectionPhysicsLoadingStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentOnChaosBreakEvent OnChaosBreakEvent;                  // 0x0680 (size: 0x10)
    void OnChaosBreakEvent(const FChaosBreakEvent& BreakEvent);
    float DesiredCacheTime;                                                           // 0x0690 (size: 0x4)
    bool CachePlayback;                                                               // 0x0694 (size: 0x1)
    FGeometryCollectionComponentOnChaosPhysicsCollision OnChaosPhysicsCollision;      // 0x0698 (size: 0x10)
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    bool bNotifyBreaks;                                                               // 0x06A8 (size: 0x1)
    bool bNotifyCollisions;                                                           // 0x06A9 (size: 0x1)
    bool bEnableReplication;                                                          // 0x06AA (size: 0x1)
    bool bEnableAbandonAfterLevel;                                                    // 0x06AB (size: 0x1)
    int32 ReplicationAbandonClusterLevel;                                             // 0x06AC (size: 0x4)
    FGeometryCollectionRepData RepData;                                               // 0x06B0 (size: 0x18)
    class UBodySetup* DummyBodySetup;                                                 // 0x08E0 (size: 0x8)
