...
{
    uint8 LogPortUnreach;                                                             // 0x0770 (size: 0x1)
    uint8 AllowPlayerPortUnreach;                                                     // 0x0770 (size: 0x1)
    uint32 MaxPortCountToTry;                                                         // 0x0774 (size: 0x4)
    uint32 ServerDesiredSocketReceiveBufferBytes;                                     // 0x0784 (size: 0x4)
    uint32 ServerDesiredSocketSendBufferBytes;                                        // 0x0788 (size: 0x4)
    uint32 ClientDesiredSocketReceiveBufferBytes;                                     // 0x078C (size: 0x4)
    uint32 ClientDesiredSocketSendBufferBytes;                                        // 0x0790 (size: 0x4)
    double MaxSecondsInReceive;                                                       // 0x0798 (size: 0x8)
    int32 NbPacketsBetweenReceiveTimeTest;                                            // 0x07A0 (size: 0x4)
    float ResolutionConnectionTimeout;                                                // 0x07A4 (size: 0x4)
