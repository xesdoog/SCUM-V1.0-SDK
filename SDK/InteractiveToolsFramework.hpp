...
class UBaseBrushTool : public UMeshSurfacePointTool
{
    ...
    FBrushStampData LastBrushStamp;                                                   // 0x00D0 (size: 0xB8)
    TSoftClassPtr<UBrushBaseProperties> PropertyClass;                                // 0x0198 (size: 0x28)
    class UBrushStampIndicator* BrushStampIndicator;                                  // 0x01C0 (size: 0x8)
...
{
    FVector Direction;                                                                // 0x0478 (size: 0xC)
    float Gap;                                                                        // 0x0484 (size: 0x4)
    float Length;                                                                     // 0x0488 (size: 0x4)
    float Thickness;                                                                  // 0x048C (size: 0x4)
...
{
    FLinearColor Color;                                                               // 0x0458 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x0468 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x046C (size: 0x4)
...
{
    FVector Origin;                                                                   // 0x0478 (size: 0xC)
    FQuat Rotation;                                                                   // 0x0490 (size: 0x10)
    FVector Dimensions;                                                               // 0x04A0 (size: 0xC)
    float LineThickness;                                                              // 0x04AC (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x04B0 (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x04B1 (size: 0x1)

}; // Size: 0x4C0

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x0478 (size: 0xC)
    float Radius;                                                                     // 0x0484 (size: 0x4)
    float Thickness;                                                                  // 0x0488 (size: 0x4)
    int32 NumSides;                                                                   // 0x048C (size: 0x4)
    bool bViewAligned;                                                                // 0x0490 (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x0491 (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x0478 (size: 0xC)
    float HandleSize;                                                                 // 0x0484 (size: 0x4)
    float Thickness;                                                                  // 0x0488 (size: 0x4)
    FVector Direction;                                                                // 0x048C (size: 0xC)
    float Length;                                                                     // 0x0498 (size: 0x4)
    bool bImageScale;                                                                 // 0x049C (size: 0x1)
...
{
    FVector DirectionX;                                                               // 0x0478 (size: 0xC)
    FVector DirectionY;                                                               // 0x0484 (size: 0xC)
    float OffsetX;                                                                    // 0x0490 (size: 0x4)
    float OffsetY;                                                                    // 0x0494 (size: 0x4)
    float LengthX;                                                                    // 0x0498 (size: 0x4)
    float LengthY;                                                                    // 0x049C (size: 0x4)
    float Thickness;                                                                  // 0x04A0 (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x04A4 (size: 0x1)
