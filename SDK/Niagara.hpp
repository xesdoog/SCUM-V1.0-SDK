...
{
    class UNiagaraSystem* Asset;                                                      // 0x0458 (size: 0x8)
    ENiagaraTickBehavior TickBehavior;                                                // 0x0460 (size: 0x1)
    int32 RandomSeedOffset;                                                           // 0x0464 (size: 0x4)
    FNiagaraUserRedirectionParameterStore OverrideParameters;                         // 0x0468 (size: 0xC8)
    uint8 bForceSolo;                                                                 // 0x0530 (size: 0x1)
    uint8 bEnableGpuComputeDebug;                                                     // 0x0530 (size: 0x1)
    uint8 bAutoDestroy;                                                               // 0x0560 (size: 0x1)
    uint8 bRenderingEnabled;                                                          // 0x0560 (size: 0x1)
    uint8 bAutoManageAttachment;                                                      // 0x0560 (size: 0x1)
    uint8 bAutoAttachWeldSimulatedBodies;                                             // 0x0560 (size: 0x1)
    float MaxTimeBeforeForceUpdateTransform;                                          // 0x0564 (size: 0x4)
    TArray<FNiagaraMaterialOverride> EmitterMaterials;                                // 0x0568 (size: 0x10)
    FNiagaraComponentOnSystemFinished OnSystemFinished;                               // 0x0580 (size: 0x10)
    void OnNiagaraSystemFinished(class UNiagaraComponent* PSystem);
    TWeakObjectPtr<class USceneComponent> AutoAttachParent;                           // 0x0590 (size: 0x8)
    FName AutoAttachSocketName;                                                       // 0x0598 (size: 0x8)
    EAttachmentRule AutoAttachLocationRule;                                           // 0x05A0 (size: 0x1)
    EAttachmentRule AutoAttachRotationRule;                                           // 0x05A1 (size: 0x1)
    EAttachmentRule AutoAttachScaleRule;                                              // 0x05A2 (size: 0x1)
