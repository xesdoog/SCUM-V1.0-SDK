...
struct FWwiseExternalSourceMediaInfo : FTableRowBase {
	...
	struct FName MediaName; // 0x0c(0x08)
	int32_t CodecID; // 0x14(0x04)
	bool bIsStreamed; // 0x18(0x01)
	bool bUseDeviceMemory; // 0x19(0x01)
	char pad_1A[0x2]; // 0x1a(0x02)
	int32_t MemoryAlignment; // 0x1c(0x04)
	int32_t PrefetchSize; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
};
