#ifndef UE4SS_SDK_ABP_M18_Smoke_Grenade_HPP
#define UE4SS_SDK_ABP_M18_Smoke_Grenade_HPP

class UABP_M18_Smoke_Grenade_C : public UGrenadeAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_M18_Smoke_Grenade(int32 EntryPoint);
}; // Size: 0xAE8
