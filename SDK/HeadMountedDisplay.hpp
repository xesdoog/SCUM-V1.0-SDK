...
{
    int32 PlayerIndex;                                                                // 0x0458 (size: 0x4)
    EControllerHand Hand;                                                             // 0x045C (size: 0x1)
    FName MotionSource;                                                               // 0x0460 (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x0468 (size: 0x1)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x046C (size: 0x1)
    bool bDisplayDeviceModel;                                                         // 0x046D (size: 0x1)
    FName DisplayModelSource;                                                         // 0x0470 (size: 0x8)
    class UStaticMesh* CustomDisplayMesh;                                             // 0x0478 (size: 0x8)
    TArray<class UMaterialInterface*> DisplayMeshMaterialOverrides;                   // 0x0480 (size: 0x10)
