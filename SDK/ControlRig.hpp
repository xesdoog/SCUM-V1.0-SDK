...
{
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0458 (size: 0x8)
    FControlRigComponentOnPostInitializeDelegate OnPostInitializeDelegate;            // 0x0460 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreSetupDelegate OnPreSetupDelegate;                        // 0x0470 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostSetupDelegate OnPostSetupDelegate;                      // 0x0480 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreUpdateDelegate OnPreUpdateDelegate;                      // 0x0490 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostUpdateDelegate OnPostUpdateDelegate;                    // 0x04A0 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    TArray<FControlRigComponentMappedElement> MappedElements;                         // 0x04B0 (size: 0x10)
    bool bResetTransformBeforeTick;                                                   // 0x04C0 (size: 0x1)
    bool bResetInitialsBeforeSetup;                                                   // 0x04C1 (size: 0x1)
    bool bUpdateRigOnTick;                                                            // 0x04C2 (size: 0x1)
    bool bUpdateInEditor;                                                             // 0x04C3 (size: 0x1)
    bool bDrawBones;                                                                  // 0x04C4 (size: 0x1)
    bool bShowDebugDrawing;                                                           // 0x04C5 (size: 0x1)
    class UControlRig* ControlRig;                                                    // 0x04C8 (size: 0x8)
