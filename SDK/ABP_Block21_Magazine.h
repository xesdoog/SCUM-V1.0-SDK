// AnimBlueprintGeneratedClass ABP_Block21_Magazine.ABP_Block21_Magazine_C
// Size: 0xc18 (Inherited: 0x2e0)
struct UABP_Block21_Magazine_C : UWeaponAttachmentMagazineAnimInstance {
	...
	struct FAnimNode_BlendListByEnum AnimGraphNode_BlendListByEnum_2; // 0x4b8(0xb0)
	...
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool_3; // 0x5e0(0xa0)
	struct FAnimNode_BlendListByEnum AnimGraphNode_BlendListByEnum; // 0x680(0xb0)
	...
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool_2; // 0x9d8(0xa0)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0xa78(0x80)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0xaf8(0xa0)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0xb98(0x80)

	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_Block21_Magazine.ABP_Block21_Magazine_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x297fc00
	void ExecuteUbergraph_ABP_Block21_Magazine(int32_t EntryPoint); // Function ABP_Block21_Magazine.ABP_Block21_Magazine_C.ExecuteUbergraph_ABP_Block21_Magazine // (Final|UbergraphFunction) // @ game+0x297fc00
};
