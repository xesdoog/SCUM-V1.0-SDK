...
{
    TLazyObjectPtr<class ALandscape> LandscapeActor;                                  // 0x05F0 (size: 0x1C)
...
{
    int32 SectionBaseX;                                                               // 0x0458 (size: 0x4)
    int32 SectionBaseY;                                                               // 0x045C (size: 0x4)
    int32 ComponentSizeQuads;                                                         // 0x0460 (size: 0x4)
    int32 SubsectionSizeQuads;                                                        // 0x0464 (size: 0x4)
    int32 NumSubsections;                                                             // 0x0468 (size: 0x4)
    class UMaterialInterface* OverrideMaterial;                                       // 0x0470 (size: 0x8)
    class UMaterialInterface* OverrideHoleMaterial;                                   // 0x0478 (size: 0x8)
    TArray<FLandscapeComponentMaterialOverride> OverrideMaterials;                    // 0x0480 (size: 0x10)
    TArray<class UMaterialInstanceConstant*> MaterialInstances;                       // 0x0490 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> MaterialInstancesDynamic;                 // 0x04A0 (size: 0x10)
    TArray<int8> LODIndexToMaterialIndex;                                             // 0x04B0 (size: 0x10)
    TArray<int8> MaterialIndexToDisabledTessellationMaterial;                         // 0x04C0 (size: 0x10)
    class UTexture2D* XYOffsetmapTexture;                                             // 0x04D0 (size: 0x8)
    FVector4 WeightmapScaleBias;                                                      // 0x04E0 (size: 0x10)
    float WeightmapSubsectionOffset;                                                  // 0x04F0 (size: 0x4)
    FVector4 HeightmapScaleBias;                                                      // 0x0500 (size: 0x10)
    FBox CachedLocalBox;                                                              // 0x0510 (size: 0x1C)
    TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent; // 0x052C (size: 0x1C)
    class UTexture2D* HeightmapTexture;                                               // 0x0548 (size: 0x8)
    TArray<FWeightmapLayerAllocationInfo> WeightmapLayerAllocations;                  // 0x0550 (size: 0x10)
    TArray<class UTexture2D*> WeightmapTextures;                                      // 0x0560 (size: 0x10)
    class ULandscapeLODStreamingProxy* LODStreamingProxy;                             // 0x0570 (size: 0x8)
    FGuid MapBuildDataId;                                                             // 0x0578 (size: 0x10)
    TArray<FGuid> IrrelevantLights;                                                   // 0x0588 (size: 0x10)
    int32 CollisionMipLevel;                                                          // 0x0598 (size: 0x4)
    int32 SimpleCollisionMipLevel;                                                    // 0x059C (size: 0x4)
    float NegativeZBoundsExtension;                                                   // 0x05A0 (size: 0x4)
    float PositiveZBoundsExtension;                                                   // 0x05A4 (size: 0x4)
    float StaticLightingResolution;                                                   // 0x05A8 (size: 0x4)
    int32 ForcedLOD;                                                                  // 0x05AC (size: 0x4)
    int32 LODBias;                                                                    // 0x05B0 (size: 0x4)
    FGuid StateId;                                                                    // 0x05B4 (size: 0x10)
    FGuid BakedTextureMaterialGuid;                                                   // 0x05C4 (size: 0x10)
    class UTexture2D* GIBakedBaseColorTexture;                                        // 0x05D8 (size: 0x8)
    uint8 MobileBlendableLayerMask;                                                   // 0x05E0 (size: 0x1)
    class UMaterialInterface* MobileMaterialInterface;                                // 0x05E8 (size: 0x8)
    TArray<class UMaterialInterface*> MobileMaterialInterfaces;                       // 0x05F0 (size: 0x10)
    TArray<class UTexture2D*> MobileWeightmapTextures;                                // 0x0600 (size: 0x10)
...
{
    TArray<class ULandscapeLayerInfoObject*> ComponentLayerInfos;                     // 0x0458 (size: 0x10)
    int32 SectionBaseX;                                                               // 0x0468 (size: 0x4)
    int32 SectionBaseY;                                                               // 0x046C (size: 0x4)
    int32 CollisionSizeQuads;                                                         // 0x0470 (size: 0x4)
    float CollisionScale;                                                             // 0x0474 (size: 0x4)
    int32 SimpleCollisionSizeQuads;                                                   // 0x0478 (size: 0x4)
    TArray<uint8> CollisionQuadFlags;                                                 // 0x0480 (size: 0x10)
    FGuid HeightfieldGuid;                                                            // 0x0490 (size: 0x10)
    FBox CachedLocalBox;                                                              // 0x04A0 (size: 0x1C)
    TLazyObjectPtr<class ULandscapeComponent> RenderComponent;                        // 0x04BC (size: 0x1C)
    TArray<class UPhysicalMaterial*> CookedPhysicalMaterials;                         // 0x04E8 (size: 0x10)
    int32 PersistentCollisionIndex;                                                   // 0x0540 (size: 0x4)
...
{
    TArray<class ULandscapeSplineControlPoint*> ControlPoints;                        // 0x0458 (size: 0x10)
    TArray<class ULandscapeSplineSegment*> Segments;                                  // 0x0468 (size: 0x10)
    TArray<class UMeshComponent*> CookedForeignMeshComponents;                        // 0x0478 (size: 0x10)
