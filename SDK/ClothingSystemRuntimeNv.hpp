...
class UClothConfigNv : public UClothConfigCommon
{
    ...
    float WindIntensityScale;                                                         // 0x0090 (size: 0x4)
    FVector LinearDrag;                                                               // 0x0094 (size: 0xC)
    FVector AngularDrag;                                                              // 0x00A0 (size: 0xC)
    FVector LinearInertiaScale;                                                       // 0x00AC (size: 0xC)
    FVector AngularInertiaScale;                                                      // 0x00B8 (size: 0xC)
    FVector CentrifugalInertiaScale;                                                  // 0x00C4 (size: 0xC)
    float SolverFrequency;                                                            // 0x00D0 (size: 0x4)
    float StiffnessFrequency;                                                         // 0x00D4 (size: 0x4)
    float GravityScale;                                                               // 0x00D8 (size: 0x4)
    FVector GravityOverride;                                                          // 0x00DC (size: 0xC)
    bool bUseGravityOverride;                                                         // 0x00E8 (size: 0x1)
    float TetherStiffness;                                                            // 0x00EC (size: 0x4)
    float TetherLimit;                                                                // 0x00F0 (size: 0x4)
    float CollisionThickness;                                                         // 0x00F4 (size: 0x4)
    float AnimDriveSpringStiffness;                                                   // 0x00F8 (size: 0x4)
    float AnimDriveDamperStiffness;                                                   // 0x00FC (size: 0x4)
    EClothingWindMethod_Legacy WindMethod;                                            // 0x0100 (size: 0x1)
    FClothConstraintSetup_Legacy VerticalConstraintConfig;                            // 0x0104 (size: 0x10)
    FClothConstraintSetup_Legacy HorizontalConstraintConfig;                          // 0x0114 (size: 0x10)
    FClothConstraintSetup_Legacy BendConstraintConfig;                                // 0x0124 (size: 0x10)
    FClothConstraintSetup_Legacy ShearConstraintConfig;                               // 0x0134 (size: 0x10)
