...
{
    class UFieldSystem* FieldSystem;                                                  // 0x0458 (size: 0x8)
    bool bIsWorldField;                                                               // 0x0460 (size: 0x1)
    bool bIsChaosField;                                                               // 0x0461 (size: 0x1)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x0468 (size: 0x10)
    FFieldObjectCommands ConstructionCommands;                                        // 0x0478 (size: 0x30)
    FFieldObjectCommands BufferCommands;                                              // 0x04A8 (size: 0x30)
