#ifndef UE4SS_SDK_BP_DeployableSentry_HPP
#define UE4SS_SDK_BP_DeployableSentry_HPP

class ABP_DeployableSentry_C : public ASentry2
{
    ...
    class UPointLightComponent* ActiveLight;                                          // 0x0F20 (size: 0x8)
    class USpotLightComponent* SpotlightFogUL;                                        // 0x0F28 (size: 0x8)
