...
{
    float ValueX;                                                                     // 0x0110 (size: 0x4)
    float ValueY;                                                                     // 0x0114 (size: 0x4)
    FSynth2DSliderValueXDelegate ValueXDelegate;                                      // 0x0118 (size: 0x10)
    float GetFloat();
    FSynth2DSliderValueYDelegate ValueYDelegate;                                      // 0x0128 (size: 0x10)
    float GetFloat();
    FSynth2DSliderStyle WidgetStyle;                                                  // 0x0138 (size: 0x2B8)
    FLinearColor SliderHandleColor;                                                   // 0x03F0 (size: 0x10)
    bool IndentHandle;                                                                // 0x0400 (size: 0x1)
    bool Locked;                                                                      // 0x0401 (size: 0x1)
    float StepSize;                                                                   // 0x0404 (size: 0x4)
    bool IsFocusable;                                                                 // 0x0408 (size: 0x1)
    FSynth2DSliderOnMouseCaptureBegin OnMouseCaptureBegin;                            // 0x0410 (size: 0x10)
    void OnMouseCaptureBeginEventSynth2D();
    FSynth2DSliderOnMouseCaptureEnd OnMouseCaptureEnd;                                // 0x0420 (size: 0x10)
    void OnMouseCaptureEndEventSynth2D();
    FSynth2DSliderOnControllerCaptureBegin OnControllerCaptureBegin;                  // 0x0430 (size: 0x10)
    void OnControllerCaptureBeginEventSynth2D();
    FSynth2DSliderOnControllerCaptureEnd OnControllerCaptureEnd;                      // 0x0440 (size: 0x10)
    void OnControllerCaptureEndEventSynth2D();
    FSynth2DSliderOnValueChangedX OnValueChangedX;                                    // 0x0450 (size: 0x10)
    void OnFloatValueChangedEventSynth2D(float Value);
    FSynth2DSliderOnValueChangedY OnValueChangedY;                                    // 0x0460 (size: 0x10)
    void OnFloatValueChangedEventSynth2D(float Value);
...
class USynthKnob : public UWidget
{
    ...
    float StepSize;                                                                   // 0x0114 (size: 0x4)
    float MouseSpeed;                                                                 // 0x0118 (size: 0x4)
    float MouseFineTuneSpeed;                                                         // 0x011C (size: 0x4)
    uint8 ShowTooltipInfo;                                                            // 0x0120 (size: 0x1)
    FText ParameterName;                                                              // 0x0128 (size: 0x18)
    FText ParameterUnits;                                                             // 0x0140 (size: 0x18)
    FSynthKnobValueDelegate ValueDelegate;                                            // 0x0158 (size: 0x10)
    float GetFloat();
    FSynthKnobStyle WidgetStyle;                                                      // 0x0168 (size: 0x238)
    bool Locked;                                                                      // 0x03A0 (size: 0x1)
    bool IsFocusable;                                                                 // 0x03A1 (size: 0x1)
    FSynthKnobOnMouseCaptureBegin OnMouseCaptureBegin;                                // 0x03A8 (size: 0x10)
    void OnMouseCaptureBeginEvent();
    FSynthKnobOnMouseCaptureEnd OnMouseCaptureEnd;                                    // 0x03B8 (size: 0x10)
    void OnMouseCaptureEndEvent();
    FSynthKnobOnControllerCaptureBegin OnControllerCaptureBegin;                      // 0x03C8 (size: 0x10)
    void OnControllerCaptureBeginEvent();
    FSynthKnobOnControllerCaptureEnd OnControllerCaptureEnd;                          // 0x03D8 (size: 0x10)
    void OnControllerCaptureEndEvent();
    FSynthKnobOnValueChanged OnValueChanged;                                          // 0x03E8 (size: 0x10)
