...
struct UBaseBrushTool : UMeshSurfacePointTool {
	...
	struct TSoftClassPtr<UObject> PropertyClass; // 0x198(0x28)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x458(0x10)
	float HoverSizeMultiplier; // 0x468(0x04)
	float PixelHitDistanceThreshold; // 0x46c(0x04)
	char pad_478[0x8]; // 0x478(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x47d3cb0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x47d3c20
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x4a0 (Inherited: 0x480)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x478(0x0c)
	float Gap; // 0x484(0x04)
	float Length; // 0x488(0x04)
	float Thickness; // 0x48c(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x478(0x0c)
	char pad_48C[0x4]; // 0x48c(0x04)
	struct FQuat Rotation; // 0x490(0x10)
	struct FVector Dimensions; // 0x4a0(0x0c)
	float LineThickness; // 0x4ac(0x04)
	bool bRemoveHiddenLines; // 0x4b0(0x01)
	bool bEnableAxisFlip; // 0x4b1(0x01)
	char pad_4B2[0xe]; // 0x4b2(0x0e)
};

// Class InteractiveToolsFramework.GizmoCircleComponent
// Size: 0x4a0 (Inherited: 0x480)
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x478(0x0c)
	float Radius; // 0x484(0x04)
	float Thickness; // 0x488(0x04)
	int32_t NumSides; // 0x48c(0x04)
	bool bViewAligned; // 0x490(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x491(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x47d3ab0
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x47d38f0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x47d3960
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x47d3800
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x47d3750
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x47d3710
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x47d3b90
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x47d36b0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x47d36d0
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x47d3990
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x47d3790
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x47d36f0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x47d36b0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x47d3a20
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x47d37c0
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x47d36f0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x47d36b0
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x478(0x0c)
	float HandleSize; // 0x484(0x04)
	float Thickness; // 0x488(0x04)
	struct FVector Direction; // 0x48c(0x0c)
	float Length; // 0x498(0x04)
	bool bImageScale; // 0x49c(0x01)
};

// Class InteractiveToolsFramework.GizmoRectangleComponent
// Size: 0x4b0 (Inherited: 0x480)
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x478(0x0c)
	struct FVector DirectionY; // 0x484(0x0c)
	float OffsetX; // 0x490(0x04)
	float OffsetY; // 0x494(0x04)
	float LengthX; // 0x498(0x04)
	float LengthY; // 0x49c(0x04)
	float Thickness; // 0x4a0(0x04)
	char SegmentFlags; // 0x4a4(0x01)
