...
{
    class AActor* Broadcaster;                                                        // 0x0038 (size: 0x8)
    class AActor* Enemy;                                                              // 0x0040 (size: 0x8)
...
struct FGenericTeamId
{
    ...
    uint64 SubteamID;                                                                 // 0x0008 (size: 0x8)
...
{
    class UEnvQuery* QueryTemplate;                                                   // 0x04D0 (size: 0x8)
    TArray<FEnvNamedValue> QueryParams;                                               // 0x04D8 (size: 0x10)
    TArray<FAIDynamicParam> QueryConfig;                                              // 0x04E8 (size: 0x10)
    float TimeLimitPerStep;                                                           // 0x04F8 (size: 0x4)
    int32 StepToDebugDraw;                                                            // 0x04FC (size: 0x4)
    EEnvQueryHightlightMode HighlightMode;                                            // 0x0500 (size: 0x1)
    uint8 bDrawLabels;                                                                // 0x0504 (size: 0x1)
    uint8 bDrawFailedItems;                                                           // 0x0504 (size: 0x1)
    uint8 bReRunQueryOnlyOnFinishedMove;                                              // 0x0504 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0504 (size: 0x1)
    uint8 bTickDuringGame;                                                            // 0x0504 (size: 0x1)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x0508 (size: 0x1)
    FNavAgentProperties NavAgentProperties;                                           // 0x0510 (size: 0x30)
...
class UAISenseConfig_Hearing : public UAISenseConfig
{
    ...
    bool bHearingOcclusionEnabled;                                                    // 0x0060 (size: 0x1)
    float HearingRangeReductionIfOccluded;                                            // 0x0064 (size: 0x4)
    TEnumAsByte<ECollisionChannel> HearingOcclusionCollisionChannel;                  // 0x0068 (size: 0x1)
...
class UAISenseConfig_Sight : public UAISenseConfig
{
    ...
    bool UseAccurateConeCheck;                                                        // 0x006C (size: 0x1)
...
{
    FAINoiseEvent Event;                                                              // 0x0028 (size: 0x38)
