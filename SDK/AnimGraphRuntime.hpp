...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
    ...
    EBoneRotationOrder RotationOrder;                                                 // 0x010F (size: 0x1)
    uint8 bUseRange;                                                                  // 0x0110 (size: 0x1)
    uint8 bAffectTargetTranslationX;                                                  // 0x0110 (size: 0x1)
    uint8 bAffectTargetTranslationY;                                                  // 0x0110 (size: 0x1)
    uint8 bAffectTargetTranslationZ;                                                  // 0x0110 (size: 0x1)
    uint8 bAffectTargetRotationX;                                                     // 0x0110 (size: 0x1)
    uint8 bAffectTargetRotationY;                                                     // 0x0110 (size: 0x1)
    uint8 bAffectTargetRotationZ;                                                     // 0x0110 (size: 0x1)
    uint8 bAffectTargetScaleX;                                                        // 0x0110 (size: 0x1)
    uint8 bAffectTargetScaleY;                                                        // 0x0111 (size: 0x1)
    uint8 bAffectTargetScaleZ;                                                        // 0x0111 (size: 0x1)
