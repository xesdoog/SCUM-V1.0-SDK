...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x0488 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x0489 (size: 0x1)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x0490 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x0498 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x04A8 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x04B8 (size: 0x1C)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x04D8 (size: 0x10)
