...
{
    class UPaperFlipbookComponent* Sprite;                                            // 0x04C8 (size: 0x8)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x0480 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0488 (size: 0x8)
    float PlayRate;                                                                   // 0x0490 (size: 0x4)
    uint8 bLooping;                                                                   // 0x0494 (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x0494 (size: 0x1)
    uint8 bPlaying;                                                                   // 0x0494 (size: 0x1)
    float AccumulatedTime;                                                            // 0x0498 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x049C (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x04A0 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x04B0 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x04B8 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x0480 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x0490 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x0480 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x0488 (size: 0x8)
    FLinearColor SpriteColor;                                                         // 0x0490 (size: 0x10)
...
{
    class UPaperTerrainMaterial* TerrainMaterial;                                     // 0x0458 (size: 0x8)
    bool bClosedSpline;                                                               // 0x0460 (size: 0x1)
    bool bFilledSpline;                                                               // 0x0461 (size: 0x1)
    class UPaperTerrainSplineComponent* AssociatedSpline;                             // 0x0468 (size: 0x8)
    int32 randomSeed;                                                                 // 0x0470 (size: 0x4)
    float SegmentOverlapAmount;                                                       // 0x0474 (size: 0x4)
    FLinearColor TerrainColor;                                                        // 0x0478 (size: 0x10)
    int32 ReparamStepsPerSegment;                                                     // 0x0488 (size: 0x4)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x048C (size: 0x1)
    float CollisionThickness;                                                         // 0x0490 (size: 0x4)
...
{
    int32 MapWidth;                                                                   // 0x0480 (size: 0x4)
    int32 MapHeight;                                                                  // 0x0484 (size: 0x4)
    int32 TileWidth;                                                                  // 0x0488 (size: 0x4)
    int32 TileHeight;                                                                 // 0x048C (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x0490 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0498 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x04A0 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x04B0 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x04C0 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x04C4 (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x04C8 (size: 0x8)
