...
class UBackgroundBlur : public UContentWidget
{
    ...
    bool bOverrideAutoRadiusCalculation;                                              // 0x0140 (size: 0x1)
    int32 BlurRadius;                                                                 // 0x0144 (size: 0x4)
    FSlateBrush LowQualityFallbackBrush;                                              // 0x0148 (size: 0x88)
...
class UBorder : public UContentWidget
{
    ...
    uint8 bShowEffectWhenDisabled;                                                    // 0x012A (size: 0x1)
    FLinearColor ContentColorAndOpacity;                                              // 0x012C (size: 0x10)
    FBorderContentColorAndOpacityDelegate ContentColorAndOpacityDelegate;             // 0x013C (size: 0x10)
    FLinearColor GetLinearColor();
    FMargin Padding;                                                                  // 0x014C (size: 0x10)
    FSlateBrush Background;                                                           // 0x0160 (size: 0x88)
    FBorderBackgroundDelegate BackgroundDelegate;                                     // 0x01E8 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor BrushColor;                                                          // 0x01F8 (size: 0x10)
    FBorderBrushColorDelegate BrushColorDelegate;                                     // 0x0208 (size: 0x10)
    FLinearColor GetLinearColor();
    FVector2D DesiredSizeScale;                                                       // 0x0218 (size: 0x8)
    bool bFlipForRightToLeftFlowDirection;                                            // 0x0220 (size: 0x1)
    FBorderOnMouseButtonDownEvent OnMouseButtonDownEvent;                             // 0x0224 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseButtonUpEvent OnMouseButtonUpEvent;                                 // 0x0234 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseMoveEvent OnMouseMoveEvent;                                         // 0x0244 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseDoubleClickEvent OnMouseDoubleClickEvent;                           // 0x0254 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
{
    class USlateWidgetStyleAsset* Style;                                              // 0x0128 (size: 0x8)
    FButtonStyle WidgetStyle;                                                         // 0x0130 (size: 0x278)
    FLinearColor ColorAndOpacity;                                                     // 0x03A8 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x03B8 (size: 0x10)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x03C8 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x03C9 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x03CA (size: 0x1)
    bool IsFocusable;                                                                 // 0x03CB (size: 0x1)
    FButtonOnClicked OnClicked;                                                       // 0x03D0 (size: 0x10)
    void OnButtonClickedEvent();
    FButtonOnPressed OnPressed;                                                       // 0x03E0 (size: 0x10)
    void OnButtonPressedEvent();
    FButtonOnReleased OnReleased;                                                     // 0x03F0 (size: 0x10)
    void OnButtonReleasedEvent();
    FButtonOnHovered OnHovered;                                                       // 0x0400 (size: 0x10)
    void OnButtonHoverEvent();
    FButtonOnUnhovered OnUnhovered;                                                   // 0x0410 (size: 0x10)
    void OnButtonHoverEvent();
...
{
    ECheckBoxState CheckedState;                                                      // 0x0128 (size: 0x1)
    FCheckBoxCheckedStateDelegate CheckedStateDelegate;                               // 0x012C (size: 0x10)
    ECheckBoxState GetCheckBoxState();
    FCheckBoxStyle WidgetStyle;                                                       // 0x0140 (size: 0x580)
    class USlateWidgetStyleAsset* Style;                                              // 0x06C0 (size: 0x8)
    class USlateBrushAsset* UncheckedImage;                                           // 0x06C8 (size: 0x8)
    class USlateBrushAsset* UncheckedHoveredImage;                                    // 0x06D0 (size: 0x8)
    class USlateBrushAsset* UncheckedPressedImage;                                    // 0x06D8 (size: 0x8)
    class USlateBrushAsset* CheckedImage;                                             // 0x06E0 (size: 0x8)
    class USlateBrushAsset* CheckedHoveredImage;                                      // 0x06E8 (size: 0x8)
    class USlateBrushAsset* CheckedPressedImage;                                      // 0x06F0 (size: 0x8)
    class USlateBrushAsset* UndeterminedImage;                                        // 0x06F8 (size: 0x8)
    class USlateBrushAsset* UndeterminedHoveredImage;                                 // 0x0700 (size: 0x8)
    class USlateBrushAsset* UndeterminedPressedImage;                                 // 0x0708 (size: 0x8)
    TEnumAsByte<EHorizontalAlignment> HorizontalAlignment;                            // 0x0710 (size: 0x1)
    FMargin Padding;                                                                  // 0x0714 (size: 0x10)
    FSlateColor BorderBackgroundColor;                                                // 0x0728 (size: 0x28)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x0750 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x0751 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x0752 (size: 0x1)
    bool IsFocusable;                                                                 // 0x0753 (size: 0x1)
    FCheckBoxOnCheckStateChanged OnCheckStateChanged;                                 // 0x0758 (size: 0x10)
...
{
    int32 NumberOfPieces;                                                             // 0x0110 (size: 0x4)
    float Period;                                                                     // 0x0114 (size: 0x4)
    float Radius;                                                                     // 0x0118 (size: 0x4)
    class USlateBrushAsset* PieceImage;                                               // 0x0120 (size: 0x8)
    FSlateBrush Image;                                                                // 0x0128 (size: 0x88)
    bool bEnableRadius;                                                               // 0x01B0 (size: 0x1)
...
{
    TArray<class UObject*> Items;                                                     // 0x0110 (size: 0x10)
    FComboBoxOnGenerateWidgetEvent OnGenerateWidgetEvent;                             // 0x0120 (size: 0x10)
    class UWidget* GenerateWidgetForObject(class UObject* Item);
    bool bIsFocusable;                                                                // 0x0130 (size: 0x1)

}; // Size: 0x148

class UComboBoxString : public UWidget
{
    TArray<FString> DefaultOptions;                                                   // 0x0110 (size: 0x10)
    FString SelectedOption;                                                           // 0x0120 (size: 0x10)
    FComboBoxStyle WidgetStyle;                                                       // 0x0130 (size: 0x3F0)
    FTableRowStyle ItemStyle;                                                         // 0x0520 (size: 0x7C8)
    FMargin ContentPadding;                                                           // 0x0CE8 (size: 0x10)
    float MaxListHeight;                                                              // 0x0CF8 (size: 0x4)
    bool HasDownArrow;                                                                // 0x0CFC (size: 0x1)
    bool EnableGamepadNavigationMode;                                                 // 0x0CFD (size: 0x1)
    FSlateFontInfo Font;                                                              // 0x0D00 (size: 0x58)
    FSlateColor ForegroundColor;                                                      // 0x0D58 (size: 0x28)
    bool bIsFocusable;                                                                // 0x0D80 (size: 0x1)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x0D84 (size: 0x10)
    class UWidget* GenerateWidgetForString(FString Item);
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x0D98 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x0DA8 (size: 0x10)
    void OnOpeningEvent();
...
{
    TSubclassOf<class UUserWidget> EntryWidgetClass;                                  // 0x01E0 (size: 0x8)
...
{
    EDynamicBoxType EntryBoxType;                                                     // 0x0110 (size: 0x1)
    FVector2D EntrySpacing;                                                           // 0x0114 (size: 0x8)
    TArray<FVector2D> SpacingPattern;                                                 // 0x0120 (size: 0x10)
    FSlateChildSize EntrySizeRule;                                                    // 0x0130 (size: 0x8)
    TEnumAsByte<EHorizontalAlignment> EntryHorizontalAlignment;                       // 0x0138 (size: 0x1)
    TEnumAsByte<EVerticalAlignment> EntryVerticalAlignment;                           // 0x0139 (size: 0x1)
    int32 MaxElementSize;                                                             // 0x013C (size: 0x4)
    FRadialBoxSettings RadialBoxSettings;                                             // 0x0140 (size: 0x10)
    FUserWidgetPool EntryWidgetPool;                                                  // 0x0160 (size: 0x80)
...
{
    FText Text;                                                                       // 0x0110 (size: 0x18)
    FEditableTextTextDelegate TextDelegate;                                           // 0x0128 (size: 0x10)
    FText GetText();
    FText HintText;                                                                   // 0x0138 (size: 0x18)
    FEditableTextHintTextDelegate HintTextDelegate;                                   // 0x0150 (size: 0x10)
    FText GetText();
    FEditableTextStyle WidgetStyle;                                                   // 0x0160 (size: 0x220)
    class USlateWidgetStyleAsset* Style;                                              // 0x0380 (size: 0x8)
    class USlateBrushAsset* BackgroundImageSelected;                                  // 0x0388 (size: 0x8)
    class USlateBrushAsset* BackgroundImageComposing;                                 // 0x0390 (size: 0x8)
    class USlateBrushAsset* CaretImage;                                               // 0x0398 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x03A0 (size: 0x58)
    FSlateColor ColorAndOpacity;                                                      // 0x03F8 (size: 0x28)
    bool IsReadOnly;                                                                  // 0x0420 (size: 0x1)
    bool IsPassword;                                                                  // 0x0421 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x0424 (size: 0x4)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x0428 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x0429 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x042A (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x042B (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x042C (size: 0x1)
    bool AllowContextMenu;                                                            // 0x042D (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x042E (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x042F (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x0430 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0431 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0432 (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x0433 (size: 0x3)
    FEditableTextOnTextChanged OnTextChanged;                                         // 0x0438 (size: 0x10)
    void OnEditableTextChangedEvent(const FText& Text);
    FEditableTextOnTextCommitted OnTextCommitted;                                     // 0x0448 (size: 0x10)
...
{
    FText Text;                                                                       // 0x0110 (size: 0x18)
    FEditableTextBoxTextDelegate TextDelegate;                                        // 0x0128 (size: 0x10)
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0138 (size: 0x7F8)
    class USlateWidgetStyleAsset* Style;                                              // 0x0930 (size: 0x8)
    FText HintText;                                                                   // 0x0938 (size: 0x18)
    FEditableTextBoxHintTextDelegate HintTextDelegate;                                // 0x0950 (size: 0x10)
    FText GetText();
    FSlateFontInfo Font;                                                              // 0x0960 (size: 0x58)
    FLinearColor ForegroundColor;                                                     // 0x09B8 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x09C8 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x09D8 (size: 0x10)
    bool IsReadOnly;                                                                  // 0x09E8 (size: 0x1)
    bool IsPassword;                                                                  // 0x09E9 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x09EC (size: 0x4)
    FMargin Padding;                                                                  // 0x09F0 (size: 0x10)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x0A00 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x0A01 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x0A02 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0A03 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0A04 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0A05 (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x0A06 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0A07 (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x0A08 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0A09 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0A0A (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x0A0B (size: 0x3)
    FEditableTextBoxOnTextChanged OnTextChanged;                                      // 0x0A10 (size: 0x10)
    void OnEditableTextBoxChangedEvent(const FText& Text);
    FEditableTextBoxOnTextCommitted OnTextCommitted;                                  // 0x0A20 (size: 0x10)
...
{
    FExpandableAreaStyle Style;                                                       // 0x0118 (size: 0x120)
    FSlateBrush BorderBrush;                                                          // 0x0238 (size: 0x88)
    FSlateColor BorderColor;                                                          // 0x02C0 (size: 0x28)
    bool bIsExpanded;                                                                 // 0x02E8 (size: 0x1)
    float MaxHeight;                                                                  // 0x02EC (size: 0x4)
    FMargin HeaderPadding;                                                            // 0x02F0 (size: 0x10)
    FMargin AreaPadding;                                                              // 0x0300 (size: 0x10)
    FExpandableAreaOnExpansionChanged OnExpansionChanged;                             // 0x0310 (size: 0x10)
    void OnExpandableAreaExpansionChanged(class UExpandableArea* Area, bool bIsExpanded);
    class UWidget* HeaderContent;                                                     // 0x0320 (size: 0x8)
    class UWidget* BodyContent;                                                       // 0x0328 (size: 0x8)
...
{
    TArray<float> ColumnFill;                                                         // 0x0128 (size: 0x10)
    TArray<float> RowFill;                                                            // 0x0138 (size: 0x10)
...
class UImage : public UWidget
{
    ...
    FImageBrushDelegate BrushDelegate;                                                // 0x0198 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor ColorAndOpacity;                                                     // 0x01A8 (size: 0x10)
    FImageColorAndOpacityDelegate ColorAndOpacityDelegate;                            // 0x01B8 (size: 0x10)
    FLinearColor GetLinearColor();
    bool bFlipForRightToLeftFlowDirection;                                            // 0x01C8 (size: 0x1)
    FImageOnMouseButtonDownEvent OnMouseButtonDownEvent;                              // 0x01CC (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
{
    FButtonStyle WidgetStyle;                                                         // 0x0110 (size: 0x278)
    FTextBlockStyle TextStyle;                                                        // 0x0388 (size: 0x270)
    FInputChord SelectedKey;                                                          // 0x05F8 (size: 0x20)
    FSlateFontInfo Font;                                                              // 0x0618 (size: 0x58)
    FMargin Margin;                                                                   // 0x0670 (size: 0x10)
    FLinearColor ColorAndOpacity;                                                     // 0x0680 (size: 0x10)
    FText KeySelectionText;                                                           // 0x0690 (size: 0x18)
    FText NoKeySpecifiedText;                                                         // 0x06A8 (size: 0x18)
    bool bAllowModifierKeys;                                                          // 0x06C0 (size: 0x1)
    bool bAllowGamepadKeys;                                                           // 0x06C1 (size: 0x1)
    TArray<FKey> EscapeKeys;                                                          // 0x06C8 (size: 0x10)
    FInputKeySelectorOnKeySelected OnKeySelected;                                     // 0x06D8 (size: 0x10)
    void OnKeySelected(FInputChord SelectedKey);
    FInputKeySelectorOnIsSelectingKeyChanged OnIsSelectingKeyChanged;                 // 0x06E8 (size: 0x10)
...
{
    bool bCanCache;                                                                   // 0x0128 (size: 0x1)
    bool CacheRelativeTransforms;                                                     // 0x0129 (size: 0x1)
...
{
    TEnumAsByte<EOrientation> Orientation;                                            // 0x02E0 (size: 0x1)
    TEnumAsByte<ESelectionMode::Type> SelectionMode;                                  // 0x02E1 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x02E2 (size: 0x1)
    bool bClearSelectionOnClick;                                                      // 0x02E3 (size: 0x1)
    bool bIsFocusable;                                                                // 0x02E4 (size: 0x1)
    float EntrySpacing;                                                               // 0x02E8 (size: 0x4)
    bool bReturnFocusToSelection;                                                     // 0x02EC (size: 0x1)
    TArray<class UObject*> ListItems;                                                 // 0x02F0 (size: 0x10)
    FListViewBP_OnEntryInitialized BP_OnEntryInitialized;                             // 0x0310 (size: 0x10)
    void OnListEntryInitializedDynamic(class UObject* Item, class UUserWidget* Widget);
    FListViewBP_OnItemClicked BP_OnItemClicked;                                       // 0x0320 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* Item);
    FListViewBP_OnItemDoubleClicked BP_OnItemDoubleClicked;                           // 0x0330 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* Item);
    FListViewBP_OnItemIsHoveredChanged BP_OnItemIsHoveredChanged;                     // 0x0340 (size: 0x10)
    void OnItemIsHoveredChangedDynamic(class UObject* Item, bool bIsHovered);
    FListViewBP_OnItemSelectionChanged BP_OnItemSelectionChanged;                     // 0x0350 (size: 0x10)
    void OnListItemSelectionChangedDynamic(class UObject* Item, bool bIsSelected);
    FListViewBP_OnItemScrolledIntoView BP_OnItemScrolledIntoView;                     // 0x0360 (size: 0x10)
...
{
    TSubclassOf<class UUserWidget> EntryWidgetClass;                                  // 0x0110 (size: 0x8)
    float WheelScrollMultiplier;                                                      // 0x0118 (size: 0x4)
    bool bEnableScrollAnimation;                                                      // 0x011C (size: 0x1)
    bool bEnableFixedLineOffset;                                                      // 0x011D (size: 0x1)
    float FixedLineScrollOffset;                                                      // 0x0120 (size: 0x4)
    FListViewBaseBP_OnEntryGenerated BP_OnEntryGenerated;                             // 0x0128 (size: 0x10)
    void OnListEntryGeneratedDynamic(class UUserWidget* Widget);
    FListViewBaseBP_OnEntryReleased BP_OnEntryReleased;                               // 0x0138 (size: 0x10)
...
{
    TSubclassOf<class UUserWidget> MenuClass;                                         // 0x0128 (size: 0x8)
    FMenuAnchorOnGetMenuContentEvent OnGetMenuContentEvent;                           // 0x0130 (size: 0x10)
    class UWidget* GetWidget();
    FMenuAnchorOnGetUserMenuContentEvent OnGetUserMenuContentEvent;                   // 0x0140 (size: 0x10)
    class UUserWidget* GetUserWidget();
    TEnumAsByte<EMenuPlacement> Placement;                                            // 0x0150 (size: 0x1)
    bool bFitInWindow;                                                                // 0x0151 (size: 0x1)
    bool ShouldDeferPaintingAfterWindowContent;                                       // 0x0152 (size: 0x1)
    bool UseApplicationMenuStack;                                                     // 0x0153 (size: 0x1)
    FMenuAnchorOnMenuOpenChanged OnMenuOpenChanged;                                   // 0x0158 (size: 0x10)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    FText HintText;                                                                   // 0x0148 (size: 0x18)
    FMultiLineEditableTextHintTextDelegate HintTextDelegate;                          // 0x0160 (size: 0x10)
    FText GetText();
    FTextBlockStyle WidgetStyle;                                                      // 0x0170 (size: 0x270)
    bool bIsReadOnly;                                                                 // 0x03E0 (size: 0x1)
    FSlateFontInfo Font;                                                              // 0x03E8 (size: 0x58)
    bool SelectAllTextWhenFocused;                                                    // 0x0440 (size: 0x1)
    bool ClearTextSelectionOnFocusLoss;                                               // 0x0441 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x0442 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0443 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0444 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0445 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0446 (size: 0x1)
    FMultiLineEditableTextOnTextChanged OnTextChanged;                                // 0x0448 (size: 0x10)
    void OnMultiLineEditableTextChangedEvent(const FText& Text);
    FMultiLineEditableTextOnTextCommitted OnTextCommitted;                            // 0x0458 (size: 0x10)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    FText Text;                                                                       // 0x0130 (size: 0x18)
    FText HintText;                                                                   // 0x0148 (size: 0x18)
    FMultiLineEditableTextBoxHintTextDelegate HintTextDelegate;                       // 0x0160 (size: 0x10)
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0170 (size: 0x7F8)
    FTextBlockStyle TextStyle;                                                        // 0x0968 (size: 0x270)
    bool bIsReadOnly;                                                                 // 0x0BD8 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0BD9 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0BDA (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0BDB (size: 0x1)
    class USlateWidgetStyleAsset* Style;                                              // 0x0BE0 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x0BE8 (size: 0x58)
    FLinearColor ForegroundColor;                                                     // 0x0C40 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0C50 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x0C60 (size: 0x10)
    FMultiLineEditableTextBoxOnTextChanged OnTextChanged;                             // 0x0C70 (size: 0x10)
    void OnMultiLineEditableTextBoxChangedEvent(const FText& Text);
    FMultiLineEditableTextBoxOnTextCommitted OnTextCommitted;                         // 0x0C80 (size: 0x10)
...
{
    TArray<class UPanelSlot*> Slots;                                                  // 0x0110 (size: 0x10)
...
{
    FProgressBarStyle WidgetStyle;                                                    // 0x0110 (size: 0x1A0)
    class USlateWidgetStyleAsset* Style;                                              // 0x02B0 (size: 0x8)
    class USlateBrushAsset* BackgroundImage;                                          // 0x02B8 (size: 0x8)
    class USlateBrushAsset* FillImage;                                                // 0x02C0 (size: 0x8)
    class USlateBrushAsset* MarqueeImage;                                             // 0x02C8 (size: 0x8)
    float Percent;                                                                    // 0x02D0 (size: 0x4)
    TEnumAsByte<EProgressBarFillType::Type> BarFillType;                              // 0x02D4 (size: 0x1)
    bool bIsMarquee;                                                                  // 0x02D5 (size: 0x1)
    FVector2D BorderPadding;                                                          // 0x02D8 (size: 0x8)
    FProgressBarPercentDelegate PercentDelegate;                                      // 0x02E0 (size: 0x10)
    float GetFloat();
    FLinearColor FillColorAndOpacity;                                                 // 0x02F0 (size: 0x10)
    FProgressBarFillColorAndOpacityDelegate FillColorAndOpacityDelegate;              // 0x0300 (size: 0x10)
    FLinearColor GetLinearColor();
...
{
    bool bRetainRender;                                                               // 0x0128 (size: 0x1)
    bool RenderOnInvalidation;                                                        // 0x0129 (size: 0x1)
    bool RenderOnPhase;                                                               // 0x012A (size: 0x1)
    int32 Phase;                                                                      // 0x012C (size: 0x4)
    int32 PhaseCount;                                                                 // 0x0130 (size: 0x4)
    class UMaterialInterface* EffectMaterial;                                         // 0x0138 (size: 0x8)
    FName TextureParameter;                                                           // 0x0140 (size: 0x8)
...
{
    FText Text;                                                                       // 0x0130 (size: 0x18)
    class UDataTable* TextStyleSet;                                                   // 0x0148 (size: 0x8)
    TArray<class TSubclassOf<URichTextBlockDecorator>> DecoratorClasses;              // 0x0150 (size: 0x10)
    bool bOverrideDefaultStyle;                                                       // 0x0160 (size: 0x1)
    FTextBlockStyle DefaultTextStyleOverride;                                         // 0x0168 (size: 0x270)
    float MinDesiredWidth;                                                            // 0x03D8 (size: 0x4)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x03DC (size: 0x1)
    FTextBlockStyle DefaultTextStyle;                                                 // 0x03E0 (size: 0x270)
    TArray<class URichTextBlockDecorator*> InstanceDecorators;                        // 0x0650 (size: 0x10)
...
{
    bool PadLeft;                                                                     // 0x0128 (size: 0x1)
    bool PadRight;                                                                    // 0x0129 (size: 0x1)
    bool PadTop;                                                                      // 0x012A (size: 0x1)
    bool PadBottom;                                                                   // 0x012B (size: 0x1)
...
{
    TEnumAsByte<EStretch::Type> Stretch;                                              // 0x0128 (size: 0x1)
    TEnumAsByte<EStretchDirection::Type> StretchDirection;                            // 0x0129 (size: 0x1)
    float UserSpecifiedScale;                                                         // 0x012C (size: 0x4)
    bool IgnoreInheritedScale;                                                        // 0x0130 (size: 0x1)
...
{
    FScrollBarStyle WidgetStyle;                                                      // 0x0110 (size: 0x4D0)
    class USlateWidgetStyleAsset* Style;                                              // 0x05E0 (size: 0x8)
    bool bAlwaysShowScrollbar;                                                        // 0x05E8 (size: 0x1)
    bool bAlwaysShowScrollbarTrack;                                                   // 0x05E9 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x05EA (size: 0x1)
    FVector2D Thickness;                                                              // 0x05EC (size: 0x8)
    FMargin Padding;                                                                  // 0x05F4 (size: 0x10)
...
{
    FScrollBoxStyle WidgetStyle;                                                      // 0x0128 (size: 0x228)
    FScrollBarStyle WidgetBarStyle;                                                   // 0x0350 (size: 0x4D0)
    class USlateWidgetStyleAsset* Style;                                              // 0x0820 (size: 0x8)
    class USlateWidgetStyleAsset* BarStyle;                                           // 0x0828 (size: 0x8)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0830 (size: 0x1)
    ESlateVisibility ScrollBarVisibility;                                             // 0x0831 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x0832 (size: 0x1)
    FVector2D ScrollbarThickness;                                                     // 0x0834 (size: 0x8)
    FMargin ScrollbarPadding;                                                         // 0x083C (size: 0x10)
    bool AlwaysShowScrollbar;                                                         // 0x084C (size: 0x1)
    bool AlwaysShowScrollbarTrack;                                                    // 0x084D (size: 0x1)
    bool AllowOverscroll;                                                             // 0x084E (size: 0x1)
    bool bAnimateWheelScrolling;                                                      // 0x084F (size: 0x1)
    EDescendantScrollDestination NavigationDestination;                               // 0x0850 (size: 0x1)
    float NavigationScrollPadding;                                                    // 0x0854 (size: 0x4)
    EScrollWhenFocusChanges ScrollWhenFocusChanges;                                   // 0x0858 (size: 0x1)
    bool bAllowRightClickDragScrolling;                                               // 0x0859 (size: 0x1)
    float WheelScrollMultiplier;                                                      // 0x085C (size: 0x4)
    FScrollBoxOnUserScrolled OnUserScrolled;                                          // 0x0860 (size: 0x10)
...
{
    float WidthOverride;                                                              // 0x0138 (size: 0x4)
    float HeightOverride;                                                             // 0x013C (size: 0x4)
    float MinDesiredWidth;                                                            // 0x0140 (size: 0x4)
    float MinDesiredHeight;                                                           // 0x0144 (size: 0x4)
    float MaxDesiredWidth;                                                            // 0x0148 (size: 0x4)
    float MaxDesiredHeight;                                                           // 0x014C (size: 0x4)
    float MinAspectRatio;                                                             // 0x0150 (size: 0x4)
    float MaxAspectRatio;                                                             // 0x0154 (size: 0x4)
    uint8 bOverride_WidthOverride;                                                    // 0x0158 (size: 0x1)
    uint8 bOverride_HeightOverride;                                                   // 0x0158 (size: 0x1)
    uint8 bOverride_MinDesiredWidth;                                                  // 0x0158 (size: 0x1)
    uint8 bOverride_MinDesiredHeight;                                                 // 0x0158 (size: 0x1)
    uint8 bOverride_MaxDesiredWidth;                                                  // 0x0158 (size: 0x1)
    uint8 bOverride_MaxDesiredHeight;                                                 // 0x0158 (size: 0x1)
    uint8 bOverride_MinAspectRatio;                                                   // 0x0158 (size: 0x1)
    uint8 bOverride_MaxAspectRatio;                                                   // 0x0158 (size: 0x1)
...
class USlider : public UWidget
{
    ...
    FSliderValueDelegate ValueDelegate;                                               // 0x0114 (size: 0x10)
    float GetFloat();
    float MinValue;                                                                   // 0x0124 (size: 0x4)
    float MaxValue;                                                                   // 0x0128 (size: 0x4)
    FSliderStyle WidgetStyle;                                                         // 0x0130 (size: 0x340)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0470 (size: 0x1)
    FLinearColor SliderBarColor;                                                      // 0x0474 (size: 0x10)
    FLinearColor SliderHandleColor;                                                   // 0x0484 (size: 0x10)
    bool IndentHandle;                                                                // 0x0494 (size: 0x1)
    bool Locked;                                                                      // 0x0495 (size: 0x1)
    bool MouseUsesStep;                                                               // 0x0496 (size: 0x1)
    bool RequiresControllerLock;                                                      // 0x0497 (size: 0x1)
    float StepSize;                                                                   // 0x0498 (size: 0x4)
    bool IsFocusable;                                                                 // 0x049C (size: 0x1)
    FSliderOnMouseCaptureBegin OnMouseCaptureBegin;                                   // 0x04A0 (size: 0x10)
    void OnMouseCaptureBeginEvent();
    FSliderOnMouseCaptureEnd OnMouseCaptureEnd;                                       // 0x04B0 (size: 0x10)
    void OnMouseCaptureEndEvent();
    FSliderOnControllerCaptureBegin OnControllerCaptureBegin;                         // 0x04C0 (size: 0x10)
    void OnControllerCaptureBeginEvent();
    FSliderOnControllerCaptureEnd OnControllerCaptureEnd;                             // 0x04D0 (size: 0x10)
    void OnControllerCaptureEndEvent();
    FSliderOnValueChanged OnValueChanged;                                             // 0x04E0 (size: 0x10)
...
{
    FVector2D Size;                                                                   // 0x0110 (size: 0x8)
...
{
    float Value;                                                                      // 0x0110 (size: 0x4)
    FSpinBoxValueDelegate ValueDelegate;                                              // 0x0114 (size: 0x10)
    float GetFloat();
    FSpinBoxStyle WidgetStyle;                                                        // 0x0128 (size: 0x2E8)
    class USlateWidgetStyleAsset* Style;                                              // 0x0410 (size: 0x8)
    int32 MinFractionalDigits;                                                        // 0x0418 (size: 0x4)
    int32 MaxFractionalDigits;                                                        // 0x041C (size: 0x4)
    bool bAlwaysUsesDeltaSnap;                                                        // 0x0420 (size: 0x1)
    float Delta;                                                                      // 0x0424 (size: 0x4)
    float SliderExponent;                                                             // 0x0428 (size: 0x4)
    FSlateFontInfo Font;                                                              // 0x0430 (size: 0x58)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0488 (size: 0x1)
    float MinDesiredWidth;                                                            // 0x048C (size: 0x4)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0490 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0491 (size: 0x1)
    FSlateColor ForegroundColor;                                                      // 0x0498 (size: 0x28)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x04C0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x04D0 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x04E0 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x04F0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x0500 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x0500 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x0500 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x0500 (size: 0x1)
    float MinValue;                                                                   // 0x0504 (size: 0x4)
    float MaxValue;                                                                   // 0x0508 (size: 0x4)
    float MinSliderValue;                                                             // 0x050C (size: 0x4)
    float MaxSliderValue;                                                             // 0x0510 (size: 0x4)
...
{
    FText Text;                                                                       // 0x0130 (size: 0x18)
    FTextBlockTextDelegate TextDelegate;                                              // 0x0148 (size: 0x10)
    FText GetText();
    FSlateColor ColorAndOpacity;                                                      // 0x0158 (size: 0x28)
    FTextBlockColorAndOpacityDelegate ColorAndOpacityDelegate;                        // 0x0180 (size: 0x10)
    FSlateColor GetSlateColor();
    FSlateFontInfo Font;                                                              // 0x0190 (size: 0x58)
    FSlateBrush StrikeBrush;                                                          // 0x01E8 (size: 0x88)
    FVector2D ShadowOffset;                                                           // 0x0270 (size: 0x8)
    FLinearColor ShadowColorAndOpacity;                                               // 0x0278 (size: 0x10)
    FTextBlockShadowColorAndOpacityDelegate ShadowColorAndOpacityDelegate;            // 0x0288 (size: 0x10)
    FLinearColor GetLinearColor();
    float MinDesiredWidth;                                                            // 0x0298 (size: 0x4)
    bool bWrapWithInvalidationPanel;                                                  // 0x029C (size: 0x1)
    bool bAutoWrapText;                                                               // 0x029D (size: 0x1)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x029E (size: 0x1)
    bool bSimpleTextMode;                                                             // 0x029F (size: 0x1)
...
{
    FShapedTextOptions ShapedTextOptions;                                             // 0x0110 (size: 0x3)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0113 (size: 0x1)
    ETextWrappingPolicy WrappingPolicy;                                               // 0x0114 (size: 0x1)
    uint8 AutoWrapText;                                                               // 0x0115 (size: 0x1)
    float WrapTextAt;                                                                 // 0x0118 (size: 0x4)
    FMargin Margin;                                                                   // 0x011C (size: 0x10)
    float LineHeightPercentage;                                                       // 0x012C (size: 0x4)
...
{
    int32 NumberOfPieces;                                                             // 0x0110 (size: 0x4)
    bool bAnimateHorizontally;                                                        // 0x0114 (size: 0x1)
    bool bAnimateVertically;                                                          // 0x0115 (size: 0x1)
    bool bAnimateOpacity;                                                             // 0x0116 (size: 0x1)
...
{
    float EntryHeight;                                                                // 0x0370 (size: 0x4)
    float EntryWidth;                                                                 // 0x0374 (size: 0x4)
    EListItemAlignment TileAlignment;                                                 // 0x0378 (size: 0x1)
    bool bWrapHorizontalNavigation;                                                   // 0x0379 (size: 0x1)
...
{
    FTreeViewBP_OnGetItemChildren BP_OnGetItemChildren;                               // 0x0380 (size: 0x10)
    void OnGetItemChildrenDynamic(class UObject* Item, TArray<class UObject*>& Children);
    FTreeViewBP_OnItemExpansionChanged BP_OnItemExpansionChanged;                     // 0x0390 (size: 0x10)
...
{
    FMargin SlotPadding;                                                              // 0x0128 (size: 0x10)
    float MinDesiredSlotWidth;                                                        // 0x0138 (size: 0x4)
    float MinDesiredSlotHeight;                                                       // 0x013C (size: 0x4)
...
{
    FLinearColor ColorAndOpacity;                                                     // 0x0118 (size: 0x10)
    FUserWidgetColorAndOpacityDelegate ColorAndOpacityDelegate;                       // 0x0128 (size: 0x10)
    FLinearColor GetLinearColor();
...
class UVerticalBox : public UPanelWidget
{
    ...
    class UVerticalBoxSlot* InsertChildAtIndexToVerticalBox(int32 Index, class UWidget* Content);
...
{
    FLinearColor BackgroundColor;                                                     // 0x0128 (size: 0x10)
...
class UWidget : public UVisual
{
    ...
    uint8 NoPixelSnapping;                                                            // 0x00C8 (size: 0x1)
    class UWidgetNavigation* Navigation;                                              // 0x00D0 (size: 0x8)
    EFlowDirectionPreference FlowDirectionPreference;                                 // 0x00D8 (size: 0x1)
    TArray<class UPropertyBinding*> NativeBindings;                                   // 0x0100 (size: 0x10)
...
{
    EWidgetSpace Space;                                                               // 0x0480 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x0481 (size: 0x1)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x0488 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x0490 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x0498 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x0499 (size: 0x1)
    float RedrawTime;                                                                 // 0x049C (size: 0x4)
    FIntPoint CurrentDrawSize;                                                        // 0x04A8 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x04B0 (size: 0x1)
    FVector2D Pivot;                                                                  // 0x04B4 (size: 0x8)
    bool bReceiveHardwareInput;                                                       // 0x04BC (size: 0x1)
    bool bWindowFocusable;                                                            // 0x04BD (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x04BE (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x04BF (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x04C0 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x04C8 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x04D8 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x04E8 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x04EC (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x04ED (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x04EE (size: 0x1)
    class UBodySetup* BodySetup;                                                      // 0x04F0 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x04F8 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x0500 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x0508 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x0510 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x0518 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x0520 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0528 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0530 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x0538 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x0539 (size: 0x1)
    FName SharedLayerName;                                                            // 0x053C (size: 0x8)
    int32 LayerZOrder;                                                                // 0x0544 (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x0548 (size: 0x1)
    float CylinderArcAngle;                                                           // 0x054C (size: 0x4)
    ETickMode TickMode;                                                               // 0x0550 (size: 0x1)
    class UUserWidget* Widget;                                                        // 0x0578 (size: 0x8)
...
class UWidgetInteractionComponent : public USceneComponent
{
    ...
    FHitResult CustomHitResult;                                                       // 0x02C0 (size: 0x98)
    FVector2D LocalHitLocation;                                                       // 0x0358 (size: 0x8)
    FVector2D LastLocalHitLocation;                                                   // 0x0360 (size: 0x8)
    class UWidgetComponent* HoveredWidgetComponent;                                   // 0x0368 (size: 0x8)
    FHitResult LastHitResult;                                                         // 0x0370 (size: 0x98)
    bool bIsHoveredWidgetInteractable;                                                // 0x0408 (size: 0x1)
    bool bIsHoveredWidgetFocusable;                                                   // 0x0409 (size: 0x1)
    bool bIsHoveredWidgetHitTestVisible;                                              // 0x040A (size: 0x1)
...
{
    int32 ActiveWidgetIndex;                                                          // 0x0128 (size: 0x4)
...
{
    bool bWindowButtonsEnabled;                                                       // 0x0128 (size: 0x1)
    bool bDoubleClickTogglesFullscreen;                                               // 0x0129 (size: 0x1)
...
{
    FVector2D InnerSlotPadding;                                                       // 0x0128 (size: 0x8)
    float WrapWidth;                                                                  // 0x0130 (size: 0x4)
    float WrapSize;                                                                   // 0x0134 (size: 0x4)
    bool bExplicitWrapWidth;                                                          // 0x0138 (size: 0x1)
    bool bExplicitWrapSize;                                                           // 0x0139 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x013A (size: 0x1)
