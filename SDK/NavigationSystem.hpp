...
class ARecastNavMesh : public ANavigationData
{
    ...
    float HeuristicScale;                                                             // 0x0540 (size: 0x4)
    float VerticalDeviationFromGroundCompensation;                                    // 0x0544 (size: 0x4)
...
{
    TArray<FNavigationLink> Links;                                                    // 0x0460 (size: 0x10)
...
class UNavigationInvokerComponent : public UActorComponent
{
    ...
    TSubclassOf<class ANavigationData> NavigationDataToUpdate;                        // 0x00B8 (size: 0x8)
...
class UNavigationSystemV1 : public UNavigationSystemBase
{
    ...
    void OnNavDataGenericEvent(class ANavigationData* NavData);
    FNavigationSystemRunMode OperationMode;                                           // 0x01AC (size: 0x1)
    float DirtyAreasUpdateFreq;                                                       // 0x15AC (size: 0x4)
    ...
    void RegisterNavigationInvoker(class AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius, TSubclassOf<class ANavigationData> NavigationDataToUpdate);
