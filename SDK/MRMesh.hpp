...
{
    class UMaterialInterface* Material;                                               // 0x0468 (size: 0x8)
    class UMaterialInterface* WireframeMaterial;                                      // 0x0470 (size: 0x8)
    bool bCreateMeshProxySections;                                                    // 0x0478 (size: 0x1)
    bool bUpdateNavMeshOnMeshUpdate;                                                  // 0x0479 (size: 0x1)
    bool bNeverCreateCollisionMesh;                                                   // 0x047A (size: 0x1)
    class UBodySetup* CachedBodySetup;                                                // 0x0480 (size: 0x8)
    TArray<class UBodySetup*> BodySetups;                                             // 0x0488 (size: 0x10)
