...
struct UDLSSSettings : UObject {
	...
	enum class EDLSSPreset DLSSQualityPreset; // 0x5c(0x01)
	enum class EDLSSPreset DLSSBalancedPreset; // 0x5d(0x01)
	enum class EDLSSPreset DLSSPerformancePreset; // 0x5e(0x01)
	enum class EDLSSPreset DLSSUltraPerformancePreset; // 0x5f(0x01)
};
