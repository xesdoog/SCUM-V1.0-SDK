...
{
    class UGeometryCache* GeometryCache;                                              // 0x0480 (size: 0x8)
    bool bRunning;                                                                    // 0x0488 (size: 0x1)
    bool bLooping;                                                                    // 0x0489 (size: 0x1)
    bool bExtrapolateFrames;                                                          // 0x048A (size: 0x1)
    float StartTimeOffset;                                                            // 0x048C (size: 0x4)
    float PlaybackSpeed;                                                              // 0x0490 (size: 0x4)
    float MotionVectorScale;                                                          // 0x0494 (size: 0x4)
    int32 NumTracks;                                                                  // 0x0498 (size: 0x4)
    float ElapsedTime;                                                                // 0x049C (size: 0x4)
    float Duration;                                                                   // 0x04D4 (size: 0x4)
    bool bManualTick;                                                                 // 0x04D8 (size: 0x1)
