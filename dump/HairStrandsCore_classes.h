...
struct UGroomComponent : UMeshComponent {
	...
	struct UGroomAsset* GroomAsset; // 0x488(0x08)
	struct UGroomCache* GroomCache; // 0x490(0x08)
	struct TArray<struct UNiagaraComponent*> NiagaraComponents; // 0x498(0x10)
	struct USkeletalMesh* SourceSkeletalMesh; // 0x4a8(0x08)
	struct UGroomBindingAsset* BindingAsset; // 0x4b0(0x08)
	struct UPhysicsAsset* PhysicsAsset; // 0x4b8(0x08)
	struct UMaterialInterface* Strands_DebugMaterial; // 0x4c0(0x08)
	struct UMaterialInterface* Strands_DefaultMaterial; // 0x4c8(0x08)
	struct UMaterialInterface* Cards_DefaultMaterial; // 0x4d0(0x08)
	struct UMaterialInterface* Meshes_DefaultMaterial; // 0x4d8(0x08)
	struct UNiagaraSystem* AngularSpringsSystem; // 0x4e0(0x08)
	struct UNiagaraSystem* CosseratRodsSystem; // 0x4e8(0x08)
	struct FString AttachmentName; // 0x4f0(0x10)
	char pad_500[0x50]; // 0x500(0x50)
	struct TArray<struct FHairGroupDesc> GroomGroupsDesc; // 0x550(0x10)
	bool bRunning; // 0x560(0x01)
	bool bLooping; // 0x561(0x01)
	bool bManualTick; // 0x562(0x01)
	char pad_563[0x1]; // 0x563(0x01)
	float ElapsedTime; // 0x564(0x04)
	char pad_568[0x48]; // 0x568(0x48)

	void SetGroomAsset(struct UGroomAsset* Asset); // Function HairStrandsCore.GroomComponent.SetGroomAsset // (Final|Native|Public|BlueprintCallable) // @ game+0xf45500
	void SetBindingAsset(struct UGroomBindingAsset* InBinding); // Function HairStrandsCore.GroomComponent.SetBindingAsset // (Final|Native|Public|BlueprintCallable) // @ game+0xf45470
};
