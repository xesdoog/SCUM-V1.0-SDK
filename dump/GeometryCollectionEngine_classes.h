...
struct UChaosDestructionListener : USceneComponent {
	...
	void SortTrailingEvents(struct TArray<struct FChaosTrailingEventData>& TrailingEvents, enum class EChaosTrailingSortMethod SortMethod); // Function GeometryCollectionEngine.ChaosDestructionListener.SortTrailingEvents // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47adf20
	void SortCollisionEvents(struct TArray<struct FChaosCollisionEventData>& CollisionEvents, enum class EChaosCollisionSortMethod SortMethod); // Function GeometryCollectionEngine.ChaosDestructionListener.SortCollisionEvents // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47ade20
	void SortBreakingEvents(struct TArray<struct FChaosBreakingEventData>& BreakingEvents, enum class EChaosBreakingSortMethod SortMethod); // Function GeometryCollectionEngine.ChaosDestructionListener.SortBreakingEvents // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47add20
	void SetTrailingEventRequestSettings(struct FChaosTrailingEventRequestSettings& InSettings); // Function GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventRequestSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47adc80
	void SetTrailingEventEnabled(bool bIsEnabled); // Function GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x47adbf0
	void SetCollisionEventRequestSettings(struct FChaosCollisionEventRequestSettings& InSettings); // Function GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventRequestSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47adac0
	void SetCollisionEventEnabled(bool bIsEnabled); // Function GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x47ada30
	void SetBreakingEventRequestSettings(struct FChaosBreakingEventRequestSettings& InSettings); // Function GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventRequestSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x47ad990
	void SetBreakingEventEnabled(bool bIsEnabled); // Function GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x47ad900
	void RemoveGeometryCollectionActor(struct AGeometryCollectionActor* GeometryCollectionActor); // Function GeometryCollectionEngine.ChaosDestructionListener.RemoveGeometryCollectionActor // (Final|Native|Public|BlueprintCallable) // @ game+0x47ad870
	void RemoveChaosSolverActor(struct AChaosSolverActor* ChaosSolverActor); // Function GeometryCollectionEngine.ChaosDestructionListener.RemoveChaosSolverActor // (Final|Native|Public|BlueprintCallable) // @ game+0x24c5c00
	bool IsEventListening(); // Function GeometryCollectionEngine.ChaosDestructionListener.IsEventListening // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x47ad570
	void AddGeometryCollectionActor(struct AGeometryCollectionActor* GeometryCollectionActor); // Function GeometryCollectionEngine.ChaosDestructionListener.AddGeometryCollectionActor // (Final|Native|Public|BlueprintCallable) // @ game+0x47ad280
	void AddChaosSolverActor(struct AChaosSolverActor* ChaosSolverActor); // Function GeometryCollectionEngine.ChaosDestructionListener.AddChaosSolverActor // (Final|Native|Public|BlueprintCallable) // @ game+0x24c5c00
};
...
struct AGeometryCollectionActor : AActor {
	...
	bool RaycastSingle(struct FVector Start, struct FVector End, struct FHitResult& OutHit); // Function GeometryCollectionEngine.GeometryCollectionActor.RaycastSingle // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x47ad6e0
};
...
struct UGeometryCollectionComponent : UMeshComponent {
	...
	struct AChaosSolverActor* ChaosSolverActor; // 0x488(0x08)
	char pad_490[0xe0]; // 0x490(0xe0)
	struct UGeometryCollection* RestCollection; // 0x570(0x08)
	struct TArray<struct AFieldSystemActor*> InitializationFields; // 0x578(0x10)
	bool Simulating; // 0x588(0x01)
	char pad_589[0x7]; // 0x589(0x07)
	enum class EObjectStateTypeEnum ObjectType; // 0x590(0x01)
	bool EnableClustering; // 0x591(0x01)
	char pad_592[0x2]; // 0x592(0x02)
	int32_t ClusterGroupIndex; // 0x594(0x04)
	int32_t MaxClusterLevel; // 0x598(0x04)
	char pad_59C[0x4]; // 0x59c(0x04)
	struct TArray<float> DamageThreshold; // 0x5a0(0x10)
	enum class EClusterConnectionTypeEnum ClusterConnectionType; // 0x5b0(0x01)
	char pad_5B1[0x3]; // 0x5b1(0x03)
	int32_t CollisionGroup; // 0x5b4(0x04)
	float CollisionSampleFraction; // 0x5b8(0x04)
	float LinearEtherDrag; // 0x5bc(0x04)
	float AngularEtherDrag; // 0x5c0(0x04)
	char pad_5C4[0x4]; // 0x5c4(0x04)
	struct UChaosPhysicalMaterial* PhysicalMaterial; // 0x5c8(0x08)
	enum class EInitialVelocityTypeEnum InitialVelocityType; // 0x5d0(0x01)
	char pad_5D1[0x3]; // 0x5d1(0x03)
	struct FVector InitialLinearVelocity; // 0x5d4(0x0c)
	struct FVector InitialAngularVelocity; // 0x5e0(0x0c)
	char pad_5EC[0x4]; // 0x5ec(0x04)
	struct UPhysicalMaterial* PhysicalMaterialOverride; // 0x5f0(0x08)
	struct FGeomComponentCacheParameters CacheParameters; // 0x5f8(0x50)
	struct FMulticastInlineDelegate NotifyGeometryCollectionPhysicsStateChange; // 0x648(0x10)
	struct FMulticastInlineDelegate NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x658(0x10)
	char pad_668[0x18]; // 0x668(0x18)
	struct FMulticastInlineDelegate OnChaosBreakEvent; // 0x680(0x10)
	float DesiredCacheTime; // 0x690(0x04)
	bool CachePlayback; // 0x694(0x01)
	char pad_695[0x3]; // 0x695(0x03)
	struct FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x698(0x10)
	bool bNotifyBreaks; // 0x6a8(0x01)
	bool bNotifyCollisions; // 0x6a9(0x01)
	bool bEnableReplication; // 0x6aa(0x01)
	bool bEnableAbandonAfterLevel; // 0x6ab(0x01)
	int32_t ReplicationAbandonClusterLevel; // 0x6ac(0x04)
	struct FGeometryCollectionRepData RepData; // 0x6b0(0x18)
	char pad_6C8[0x218]; // 0x6c8(0x218)
	struct UBodySetup* DummyBodySetup; // 0x8e0(0x08)
	char pad_8E8[0x28]; // 0x8e8(0x28)

	void SetNotifyBreaks(bool bNewNotifyBreaks); // Function GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks // (Final|Native|Public|BlueprintCallable) // @ game+0x47adb60
	void ReceivePhysicsCollision(struct FChaosPhysicsCollisionInfo& CollisionInfo); // Function GeometryCollectionEngine.GeometryCollectionComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x297fc00
	void OnRep_RepData(struct FGeometryCollectionRepData& OldData); // Function GeometryCollectionEngine.GeometryCollectionComponent.OnRep_RepData // (Final|Native|Protected|HasOutParms) // @ game+0x47ad630
	void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(struct UGeometryCollectionComponent* FracturedComponent); // DelegateFunction GeometryCollectionEngine.GeometryCollectionComponent.NotifyGeometryCollectionPhysicsStateChange__DelegateSignature // (MulticastDelegate|Public|Delegate) // @ game+0x297fc00
	...
	void NetAbandonCluster(int32_t TransformIndex); // Function GeometryCollectionEngine.GeometryCollectionComponent.NetAbandonCluster // (Final|Net|NetReliableNative|Event|NetMulticast|Private) // @ game+0x47ad5a0
	void ApplyPhysicsField(bool Enabled, enum class EGeometryCollectionPhysicsTypeEnum Target, struct UFieldSystemMetaData* MetaData, struct UFieldNodeBase* Field); // Function GeometryCollectionEngine.GeometryCollectionComponent.ApplyPhysicsField // (Final|Native|Public|BlueprintCallable) // @ game+0x47ad3f0
	void ApplyKinematicField(float Radius, struct FVector position); // Function GeometryCollectionEngine.GeometryCollectionComponent.ApplyKinematicField // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x47ad310
};
...
struct USkeletalMeshSimulationComponent : UActorComponent {
	...
	void ReceivePhysicsCollision(struct FChaosPhysicsCollisionInfo& CollisionInfo); // Function GeometryCollectionEngine.SkeletalMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x297fc00
};
...
struct UStaticMeshSimulationComponent : UActorComponent {
	...
	void ReceivePhysicsCollision(struct FChaosPhysicsCollisionInfo& CollisionInfo); // Function GeometryCollectionEngine.StaticMeshSimulationComponent.ReceivePhysicsCollision // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x297fc00
	void ForceRecreatePhysicsState(); // Function GeometryCollectionEngine.StaticMeshSimulationComponent.ForceRecreatePhysicsState // (Final|Native|Public|BlueprintCallable) // @ game+0x47ad550
};
