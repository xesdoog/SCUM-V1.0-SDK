...
// Enum AnimGraphRuntime.EBoneRotationOrder
enum class EBoneRotationOrder : uint8 {
	XYZ = 0,
	XZY = 1,
	YXZ = 2,
	YZX = 3,
...
struct FAnimNode_BoneDrivenController : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneRotationOrder RotationOrder; // 0x10f(0x01)
	char bUseRange : 1; // 0x110(0x01)
	char bAffectTargetTranslationX : 1; // 0x110(0x01)
	char bAffectTargetTranslationY : 1; // 0x110(0x01)
	char bAffectTargetTranslationZ : 1; // 0x110(0x01)
	char bAffectTargetRotationX : 1; // 0x110(0x01)
	char bAffectTargetRotationY : 1; // 0x110(0x01)
	char bAffectTargetRotationZ : 1; // 0x110(0x01)
	char bAffectTargetScaleX : 1; // 0x110(0x01)
	char bAffectTargetScaleY : 1; // 0x111(0x01)
	char bAffectTargetScaleZ : 1; // 0x111(0x01)
	char pad_111_2 : 6; // 0x111(0x01)
