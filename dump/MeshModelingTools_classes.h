...
struct UBakeMeshAttributeMapsToolProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetUVLayerNamesFunc(); // Function MeshModelingTools.BakeMeshAttributeMapsToolProperties.GetUVLayerNamesFunc // (Final|Native|Public) // @ game+0xd477f0
};
...
struct UDisplaceMeshCommonProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetWeightMapsFunc(); // Function MeshModelingTools.DisplaceMeshCommonProperties.GetWeightMapsFunc // (Final|Native|Public) // @ game+0xd4c470
};
...
struct UDynamicMeshBrushTool : UBaseBrushTool {
	struct UPreviewMesh* PreviewMesh; // 0x1c8(0x08)
...
struct UDynamicSculptToolActions : UInteractiveToolPropertySet {
	...
	void DiscardAttributes(); // Function MeshModelingTools.DynamicSculptToolActions.DiscardAttributes // (Final|Native|Public) // @ game+0xd4c450
};
...
struct UEditMeshPolygonsToolActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Retriangulate(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Retriangulate // (Final|Native|Public) // @ game+0xd51280
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions.RecalcNormals // (Final|Native|Public) // @ game+0xd51260
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Outset // (Final|Native|Public) // @ game+0xd51200
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Offset // (Final|Native|Public) // @ game+0xd511e0
	void Merge(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Merge // (Final|Native|Public) // @ game+0xd511c0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Inset // (Final|Native|Public) // @ game+0xd51180
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Flip // (Final|Native|Public) // @ game+0xd51120
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Extrude // (Final|Native|Public) // @ game+0xd510e0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Disconnect // (Final|Native|Public) // @ game+0xd510c0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Delete // (Final|Native|Public) // @ game+0xd510a0
	void Decompose(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Decompose // (Final|Native|Public) // @ game+0xd51080
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions.CutFaces // (Final|Native|Public) // @ game+0xd51060
};
...
struct UEditMeshPolygonsToolActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.RecalcNormals // (Final|Native|Public) // @ game+0xd51260
	void Poke(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Poke // (Final|Native|Public) // @ game+0xd51240
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Outset // (Final|Native|Public) // @ game+0xd51200
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Offset // (Final|Native|Public) // @ game+0xd511e0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Inset // (Final|Native|Public) // @ game+0xd51180
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Flip // (Final|Native|Public) // @ game+0xd51120
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Extrude // (Final|Native|Public) // @ game+0xd510e0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Disconnect // (Final|Native|Public) // @ game+0xd510c0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Delete // (Final|Native|Public) // @ game+0xd510a0
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.CutFaces // (Final|Native|Public) // @ game+0xd51060
};
...
struct UEditMeshPolygonsToolUVActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void PlanarProjection(); // Function MeshModelingTools.EditMeshPolygonsToolUVActions.PlanarProjection // (Final|Native|Public) // @ game+0xd51220
};
...
struct UEditMeshPolygonsToolEdgeActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Weld // (Final|Native|Public) // @ game+0xd51340
	void Straighten(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Straighten // (Final|Native|Public) // @ game+0xd51300
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.FillHole // (Final|Native|Public) // @ game+0xd51100
};
...
struct UEditMeshPolygonsToolEdgeActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Weld // (Final|Native|Public) // @ game+0xd51340
	void Split(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Split // (Final|Native|Public) // @ game+0xd512e0
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Flip // (Final|Native|Public) // @ game+0xd51140
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.FillHole // (Final|Native|Public) // @ game+0xd51100
	void Collapse(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Collapse // (Final|Native|Public) // @ game+0xd51040
};
...
struct UEditPivotToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Top(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Top // (Final|Native|Public) // @ game+0xd51320
	void Right(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Right // (Final|Native|Public) // @ game+0xd512a0
	void Left(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Left // (Final|Native|Public) // @ game+0xd511a0
	void Front(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Front // (Final|Native|Public) // @ game+0xd51160
	void Center(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Center // (Final|Native|Public) // @ game+0xd51000
	void Bottom(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Bottom // (Final|Native|Public) // @ game+0xd50fe0
	void Back(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Back // (Final|Native|Public) // @ game+0xd50fc0
};
...
struct UHoleFillToolActions : UInteractiveToolPropertySet {
	...
	void SelectAll(); // Function MeshModelingTools.HoleFillToolActions.SelectAll // (Final|Native|Public) // @ game+0xd512c0
	void Clear(); // Function MeshModelingTools.HoleFillToolActions.Clear // (Final|Native|Public) // @ game+0xd51020
};
...
// Size: 0x640 (Inherited: 0x208)
struct UMeshAttributePaintTool : UDynamicMeshBrushTool {
	struct UMeshAttributePaintToolProperties* AttribProps; // 0x208(0x08)
	char pad_210[0x430]; // 0x210(0x430)
};
...
struct UMeshSelectionEditActions : UMeshSelectionToolActionPropertySet {
	...
	void Shrink(); // Function MeshModelingTools.MeshSelectionEditActions.Shrink // (Final|Native|Public) // @ game+0xd56430
	void SelectLargestComponentByTriCount(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByTriCount // (Final|Native|Public) // @ game+0xd563f0
	void SelectLargestComponentByArea(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByArea // (Final|Native|Public) // @ game+0xd563d0
	void SelectAll(); // Function MeshModelingTools.MeshSelectionEditActions.SelectAll // (Final|Native|Public) // @ game+0xd563b0
	void OptimizeSelection(); // Function MeshModelingTools.MeshSelectionEditActions.OptimizeSelection // (Final|Native|Public) // @ game+0xd56390
	void Invert(); // Function MeshModelingTools.MeshSelectionEditActions.Invert // (Final|Native|Public) // @ game+0xd56370
	void Grow(); // Function MeshModelingTools.MeshSelectionEditActions.Grow // (Final|Native|Public) // @ game+0xd56350
	void ExpandToConnected(); // Function MeshModelingTools.MeshSelectionEditActions.ExpandToConnected // (Final|Native|Public) // @ game+0xd56310
	void Clear(); // Function MeshModelingTools.MeshSelectionEditActions.Clear // (Final|Native|Public) // @ game+0xd56290
};
...
struct UMeshSelectionMeshEditActions : UMeshSelectionToolActionPropertySet {
	...
	void SeparateTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.SeparateTriangles // (Final|Native|Public) // @ game+0xd56410
	void FlipNormals(); // Function MeshModelingTools.MeshSelectionMeshEditActions.FlipNormals // (Final|Native|Public) // @ game+0xd56330
	void DisconnectTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DisconnectTriangles // (Final|Native|Public) // @ game+0xd562f0
	void DeleteTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DeleteTriangles // (Final|Native|Public) // @ game+0xd562d0
	void CreatePolygroup(); // Function MeshModelingTools.MeshSelectionMeshEditActions.CreatePolygroup // (Final|Native|Public) // @ game+0xd562b0
};
...
// Size: 0x4c0 (Inherited: 0x208)
struct UMeshSelectionTool : UDynamicMeshBrushTool {
	struct UMeshSelectionToolProperties* SelectionProps; // 0x208(0x08)
	struct UMeshSelectionEditActions* SelectionActions; // 0x210(0x08)
	struct UMeshSelectionToolActionPropertySet* EditActions; // 0x218(0x08)
	struct UMeshSelectionSet* Selection; // 0x220(0x08)
	struct TArray<struct AActor*> SpawnedActors; // 0x228(0x10)
	char pad_238[0x288]; // 0x238(0x288)
};
...
struct UMirrorToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Up(); // Function MeshModelingTools.MirrorToolActionPropertySet.Up // (Final|Native|Public) // @ game+0xd5b240
	void ShiftToCenter(); // Function MeshModelingTools.MirrorToolActionPropertySet.ShiftToCenter // (Final|Native|Public) // @ game+0xd5b220
	void Right(); // Function MeshModelingTools.MirrorToolActionPropertySet.Right // (Final|Native|Public) // @ game+0xd5b200
	void Left(); // Function MeshModelingTools.MirrorToolActionPropertySet.Left // (Final|Native|Public) // @ game+0xd5b1e0
	void Forward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Forward // (Final|Native|Public) // @ game+0xd5b1c0
	void Down(); // Function MeshModelingTools.MirrorToolActionPropertySet.Down // (Final|Native|Public) // @ game+0xd5b1a0
	void Backward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Backward // (Final|Native|Public) // @ game+0xd5b160
};
...
struct UPlaneCutTool : UMultiSelectionTool {
	...
	void Cut(); // Function MeshModelingTools.PlaneCutTool.Cut // (Final|Native|Protected) // @ game+0xd5b180
};
...
struct USeamSculptTool : UDynamicMeshBrushTool {
	struct USeamSculptToolProperties* Settings; // 0x208(0x08)
	struct UPreviewGeometry* PreviewGeom; // 0x210(0x08)
	char pad_218[0xd0]; // 0x218(0xd0)
};
