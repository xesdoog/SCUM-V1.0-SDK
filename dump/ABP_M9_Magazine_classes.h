...
struct UABP_M9_Magazine_C : UWeaponAttachmentMagazineAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_M9_Magazine.ABP_M9_Magazine_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x297fc00
	void ExecuteUbergraph_ABP_M9_Magazine(int32_t EntryPoint); // Function ABP_M9_Magazine.ABP_M9_Magazine_C.ExecuteUbergraph_ABP_M9_Magazine // (Final|UbergraphFunction) // @ game+0x297fc00
};
